...
import { getSecure, URL_EMPLOYEES_SECURE } from "data/ApiData";
...
const Employee = () => {
	...
	const getEmployeesSecure = async (token) => {
		const res = await getSecure(URL_EMPLOYEES_SECURE, token);
		console.log("employee", res);
		setEmployeeState(res);
		setEmployeeIo(res);
	};
	...
	useEffect(() => {
		if (session) {
			...
			console.log('jwt', session?.id_token);
			console.log('username', session?.username);
			getEmployeesSecure(session?.id_token)
		}
	}, [session]);
